            ...
            <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5 lg:p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="{{ route('teacher.examinations.index') }}" class="text-sm text-brand-500 hover:text-brand-600">← Back to List</a>
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1">
                                    ...
                                    @else
                                        <span class="inline-flex rounded-full px-3 py-1 text-sm font-semibold bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400">Inactive</span>
                                    @endif
                                </p>
                            </div>
                            <div>
                    ...
                    <div class="mt-6 flex items-center gap-4">
                        <a href="{{ route('teacher.examinations.edit', $examination) }}"
                        ...
                        <form action="{{ route('teacher.examinations.destroy', $examination) }}" method="POST" class="inline" onsubmit="return confirm('Delete this examination?')">
                            @csrf @method('DELETE')
                            <button class="rounded-lg border border-red-300 bg-white px-5 py-2.5 text-sm font-medium text-red-700 transition hover:bg-red-50 dark:border-red-600 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-red-900/20">
                                Delete
                            </button>
                        </form>
                    </div>
