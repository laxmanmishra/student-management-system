    ...
    <div class="relative flex flex-col flex-1 overflow-x-hidden overflow-y-auto">
        ...
        <main>
            <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
                <div x-data="{ pageName: `Attendance Report`}">
                    @include('partials.breadcrumb')
                </div>

                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5 lg:p-6">
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Monthly Attendance Report</h3>
                    </div>

                    <form method="GET" action="{{ route('teacher.attendance.report') }}" class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    @else
                        <div class="text-center py-8 text-gray-500 dark:text-gray-400">
                            Select a class, section and month to generate a report.
                        </div>
                    @endif
                </div>
            </div>
