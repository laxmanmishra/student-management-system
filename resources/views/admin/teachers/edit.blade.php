            ...
            <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800 sm:px-6">
                        <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Edit Teacher</h3>
                    </div>

                    <form action="{{ route('admin.teachers.update', $teacher) }}" method="POST" enctype="multipart/form-data" class="p-5 sm:p-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="city" id="city" value="{{ old('city', $teacher->city) }}"
                                       class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="state" id="state" value="{{ old('state', $teacher->state) }}"
                                       class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="zip" id="zip" value="{{ old('zip', $teacher->zip) }}"
                                       class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="country" id="country" value="{{ old('country', $teacher->country) }}"
                                       class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-gray-800 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white">
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                @if($teacher->avatar)
                                    <div class="mb-3 flex items-center gap-3">
                                        <img src="{{ Storage::url($teacher->avatar) }}" alt="Current avatar" class="h-16 w-16 rounded-full object-cover">
