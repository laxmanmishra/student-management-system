            ...
            <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="flex items-center justify-between px-5 py-4 sm:px-6">
                        <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Classes</h3>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-t border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-gray-900/50">
                                    ...
                                    <th class="px-5 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Numeric Name</th>
                                    <th class="px-5 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Class Teacher</th>
                                    <th class="px-5 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Sections</th>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                                @forelse($classes as $class)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/50">
                                        ...
                                        <td class="px-5 py-4 text-gray-600 dark:text-gray-400">{{ $class->numeric_name ?? '-' }}</td>
                                        <td class="px-5 py-4 text-gray-600 dark:text-gray-400">
                                            {{ $class->classTeacher ? $class->classTeacher->first_name . ' ' . $class->classTeacher->last_name : '-' }}
                                        </td>
                                        <td class="px-5 py-4 text-gray-600 dark:text-gray-400">{{ $class->sections->count() }}</td>
                                        <td class="px-5 py-4">
                                            @if($class->is_active)
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-5 py-8 text-center text-gray-500 dark:text-gray-400">
                                            No classes found. <a href="{{ route('admin.classes.create') }}" class="text-brand-500 hover:underline">Add one now</a>.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
